...
public class UserController {
    ...
    @GetMapping("")
    public ResponseEntity<Page<ReviewDTO>> getBookmarkedReviews(@RequestParam(required = false) String keyword,
    ...
    @GetMapping("/reviews")
    public ResponseEntity<Page<ReviewDTO>> getCurrentUserReviews(@RequestParam(required = false) String keyword,
                                                                 @RequestParam(required = false, defaultValue = "0") int pageNumber,
                                                                 @RequestParam(required = false, defaultValue = "30") int pageSize) {
    ...
    public ResponseEntity<Void> putLocationReview(@PathVariable Long id, ReviewDTO reviewDTO) {
